...
fid.write('const uint32_t c_firmware_version = 0x%s;\n' %format(fwver, '08X'));
fid.write('const uint32_t c_build_time = 0x%s;\n\n' %format(datetime, '08X'));

fid.close();


fid = open("./01_common/fwver.h", 'w');
# write *.h file
fid.write('#ifndef __FWVER_H__\n');
fid.write('#define __FWVER_H__\n\n');
fid.write('#include <stdint.h>\n\n');
fid.write('extern const uint32_t c_firmware_version;\n');
fid.write('extern const uint32_t c_build_time;\n\n');
fid.write('#endif\n');
